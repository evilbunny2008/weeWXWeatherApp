...
Unlike general weather apps, which get data from third party websites, this app gets data from weather stations connected to a server hosting output from weeWX.
